...
export default function Page() {
  return (
    <SubPageLayout category="歯並びの種類・症状から矯正治療を知る" enTitle="UNDERBITE" jpTitle="うけ口（下顎前突）" heroSrc="/photos/model-underbite-side.jpg" heroIllust={TYPE_VISUAL === "illust" ? "/photos/illust-underbite.png" : undefined}>
