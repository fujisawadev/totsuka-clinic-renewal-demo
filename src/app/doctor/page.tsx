        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4 text-[14px] leading-loose text-[#222]">
              ...
              <p>大学病院や一般の歯科からご紹介を頂くことも多く、患者様はお子さんや20〜30代の方が中心です。近頃は親子二代で来院される方や、中高年の方も増えています。</p>
              <p>皆さんの歯並びが良くなるにつれ表情が明るく豊かになり、笑顔で通院いただけるようになるのを見るのは本当に嬉しい瞬間です。治療の際は、患者様に我慢を強いるようなことは行いません。治療に対するご要望や不安は一人ひとり異なりますので、よく話し合い、個々に適した「患者様に寄り添った治療」を心掛けています。</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4 text-[14px] leading-loose text-[#222]">
              ...
              <p>幼い頃からこの医院を身近に感じながら育ち、たくさんの患者様に信頼され、親しまれている姿を見てきました。今、自分自身が歯科医師としてこの地域で診療できることを、大変嬉しく思っています。</p>
              <p>矯正治療は、歯並びを整えるだけではなく、その方のこれからの生活や笑顔にも関わる大切な治療です。だからこそ、患者様一人ひとりに親身に接し、それぞれのお悩みや希望にしっかり耳を傾けながら、納得して治療を受けていただけることを大切にしています。</p>
              <p>また、日々知識と技術を磨き、安心して通っていただける矯正歯科医療を提供してまいります。これからも患者様一人ひとりに寄り添い、「ここで治療してよかった」と思っていただける歯科医院を目指してまいります。</p>
            </div>
          </div>
        </div>
      </PageSection>
