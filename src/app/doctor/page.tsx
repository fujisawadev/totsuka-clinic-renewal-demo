    ...
    <SubPageLayout category="医院について" enTitle="DOCTOR & STAFF" jpTitle="医師・スタッフ紹介">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4 text-[14px] leading-loose text-[#222]">
              ...
              <p>皆さんの歯並びが良くなるにつれ表情が明るく豊かになり、笑顔で通院いただけるようになるのを見るのは本当に嬉しい瞬間です。治療の際は、患者さんに我慢を強いるようなことは行いません。治療に対するご要望や不安は一人ひとり異なりますので、よく話し合い、個々に適した「患者さんに寄り添った治療」を心掛けています。</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-8 space-y-4 text-[14px] leading-loose text-[#222]">
              ...
              <p>幼い頃からこの医院を身近に感じながら育ち、たくさんの患者さんに信頼され、親しまれている姿を見てきました。今、自分自身が歯科医師としてこの地域で診療できることを、大変嬉しく思っています。</p>
              <p>矯正治療は、歯並びを整えるだけではなく、その方のこれからの生活や笑顔にも関わる大切な治療です。だからこそ、患者さん一人ひとりに親身に接し、それぞれのお悩みや希望にしっかり耳を傾けながら、納得して治療を受けていただけることを大切にしています。</p>
              <p>また、日々知識と技術を磨き、安心して通っていただける矯正歯科医療を提供してまいります。これからも患者さん一人ひとりに寄り添い、「ここで治療してよかった」と思っていただける歯科医院を目指してまいります。</p>
            </div>
          </div>
        </div>
      </PageSection>
      ...
      <PageSection enTitle="Certified Orthodontists" jpTitle="日本矯正歯科学会認定医">
        ...
        <p className="mt-10 text-[14px] leading-loose text-[#222] max-w-3xl">
          当院には、院長・副院長のほかにも日本矯正歯科学会認定医が多数在籍しています。矯正治療に精通したドクターが、患者さん一人ひとりの治療にあたります。
        </p>
      </PageSection>
      ...
      <PageSection enTitle="Staff" jpTitle="スタッフ" bg="soft">
        ...
        <p className="mt-8 text-[14px] leading-loose text-[#222] max-w-3xl">
          矯正治療に精通したスタッフが、受付から診療のサポートまで、患者さんを温かくお迎えいたします。
        </p>
      </PageSection>
    </SubPageLayout>
  );
