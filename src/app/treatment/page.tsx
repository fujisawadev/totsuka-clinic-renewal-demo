...
export default function Page() {
  return (
    <SubPageLayout category="矯正治療" enTitle="ABOUT ORTHODONTICS" jpTitle="矯正治療について" heroSrc="/photos/appliance-hero.jpg">
      ...
      <PageSection enTitle="Cooperation" jpTitle="患者様・保護者の方の協力が大切です" bg="soft">
        <div className="max-w-3xl space-y-4 text-[14px] leading-loose text-[#222]">
          ...
          <p>より良い治療結果を得るためには、患者様・保護者の方の協力が非常に大切です。担当医の指示に従い、健康で美しい歯並びのために頑張りましょう。素晴らしい笑顔で未来へ思い切りはばたいてください。</p>
        </div>
      </PageSection>
    </SubPageLayout>
  );
