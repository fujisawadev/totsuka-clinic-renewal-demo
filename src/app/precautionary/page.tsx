...
const MEDICAL = [
  ...
  "矯正装置を入れると痛みや違和感を生じることがあります。痛みの程度は患者さんによって異なりますが、通常 1 週間くらいでおさまります。",
  ...
  return (
    <SubPageLayout category="治療に関するご注意" enTitle="PRECAUTIONARY" jpTitle="治療に関するご注意" heroSrc="/photos/clinic-sterilization.jpg">
      ...
      <PageSection enTitle="Retreatment" jpTitle="再治療について" bg="soft">
        <p className="text-[14px] leading-loose text-[#222] max-w-3xl">
          再治療につきましては、定期的に通院し保定装置を指示通り装着していた場合に限り行います。なお、患者さんのご希望に基づき保定装置を除去した後に行う再治療につきましては、保証の対象とはなりませんのでご注意ください。
        </p>
      </PageSection>

      <PageSection enTitle="Discontinuation" jpTitle="矯正治療の中止について">
        <p className="text-[14px] leading-loose text-[#222] max-w-3xl">
          治療途中において患者さん自身の判断で来院しなくなった場合、施術料の返却やその後のトラブルについては一切責任を負いかねます。また、最終来院時から 5 年以上経過した場合には初診として扱うことになり、改めて治療費をいただくことになりますのでご注意ください。
        </p>
      </PageSection>
    </SubPageLayout>
  );
