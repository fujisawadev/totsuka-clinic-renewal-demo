...
const FEATURES = [
  { num: "01", title: "1987年開業以来、地域に根ざした安心安全な矯正歯科治療", body: "開業から続く実績と臨床経験をもとに、地域の皆さまに寄り添いながら、患者さん一人ひとりに安心・安全な治療をご提案します。", src: "/photos/feature-exterior.jpg" },
  ...
  { num: "03", title: "日本矯正歯科学会認定医による診療", body: "歯学博士・日本矯正歯科学会認定医の院長が診療を担当。大学病院で臨床教授を務めた経験をもとに、患者さんに寄り添った治療をご提供します。", src: "/photos/feature-certificates.jpg" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-start">
          ...
          <div className="lg:col-span-6 anim anim-delay-1">
            <div className="space-y-5 text-[15px] leading-loose text-[#222]">
              ...
              <p>
                アットホームな雰囲気のなかで、患者さんに寄り添った診療を行っておりますので、安心して通院いただけます。
              </p>
            </div>
            <div className="w-full h-px bg-[#e3e3e3] my-10" />
          </div>
          <div className="lg:col-span-4 anim anim-delay-2">
            <Photo src="/photos/concept-counseling.jpg" alt="患者さんと対話する院長" ratio="3/4" className="w-full" />
          </div>
        </div>
