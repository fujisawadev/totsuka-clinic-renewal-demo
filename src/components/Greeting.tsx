    ...
    <section id="greeting" className="bg-white pt-16 lg:pt-32 pb-16 lg:pb-40 relative">
      ...
      <div className="lg:hidden px-6">
        ...
        <div className="anim anim-delay-1 space-y-5 text-[14px] leading-[2] text-[#222]">
          ...
          <p>
            皆さんの歯並びが良くなるにつれ表情が明るく豊かになり、笑顔で通院いただけるようになるのを見るのは本当に嬉しい瞬間です。治療の際は、患者様に我慢を強いるようなことは行いません。
          </p>
          <p>
            治療に対するご要望や不安は一人ひとり異なりますので、よく話し合い、個々に適した「患者様に寄り添った治療」を心掛けています。これからも地域の皆さまに信頼いただける医療を提供してまいります。
          </p>
        </div>
      </div>
